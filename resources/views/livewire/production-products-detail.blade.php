    ...
    <x-tables.card-overflow>
        <x-table>
            <x-slot name="head">
                <tr>
                    <x-tables.th-left>
                        @lang('crud.production_products.inputs.product_id')
                    </x-tables.th-left>
                    <x-tables.th-left>
                        @lang('crud.production_products.inputs.quantity')
                    </x-tables.th-left>
                    <th></th>
                </tr>
            </x-slot>
                    ...
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="px-4 py-3 text-right" style="width: 70px;">
                            <div role="group" aria-label="Row Actions" class="relative inline-flex align-middle">
                                {{-- @can('delete-any', App\Models\Production::class) --}}
