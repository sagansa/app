  <nav class="flex-1 px-2 pb-4 space-y-1">
      ...
      <ul class="space-y-2">
          ...
          @if (Auth::user()->can('view-any', App\Models\Customer::class) ||
              ...
              <x-sidebars.nav-dropdown-desktop control="transactions" title="Transactions">
                  <x-slot name="content">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                          stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  ...
                  {{-- @can('view-any', App\Models\Receipts::class)
                        ...
                        @endcan --}}
              </x-sidebars.nav-dropdown-desktop>
          @endif
          ...
          @if (Auth::user()->can('view-any', App\Models\Production::class) ||
              ...
              Auth::user()->can('view-any', App\Models\UtilityConsumption::class) ||
              Auth::user()->can('view-any', App\Models\RequestStock::class) ||
              Auth::user()->can('view-any', App\Models\UtilityReport::class))
              <x-sidebars.nav-dropdown-desktop control="stock-managements" title="Stock Managements">
                  <x-slot name="content">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                          stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  ...
                  @endcan
                  @can('view-any', App\Models\Consumption::class)
                      <x-sidebars.dropdown-link href="{{ route('consumptions.index') }}">
                          Consumptions
                      </x-sidebars.dropdown-link>
                  @endcan
                  ...
                  @endcan
                  @can('view-any', App\Models\UtilityConsumption::class)
                      <x-sidebars.dropdown-link href="{{ route('utility-consumptions.index') }}">
          ...
          @if (Auth::user()->can('view-any', App\Models\Vehicle::class) ||
              ...
              <x-sidebars.nav-dropdown-desktop control="asset-managements" title="Asset Managements">
                  <x-slot name="content">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                          stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  ...
                  @can('view-any', App\Models\MovementAsset::class)
                      <x-sidebars.dropdown-link href="{{ route('movement-assets.index') }}">
                          Movement Assets
                      </x-sidebars.dropdown-link>
                  @endcan
          ...
          @if (Auth::user()->can('view-any', App\Models\Employee::class) ||
              ...
              <x-sidebars.nav-dropdown-desktop control="hrd" title="HRD">
                  <x-slot name="content">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                          stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          @if (Auth::user()->can('view-any', App\Models\CleanAndNeat::class) ||
              Auth::user()->can('view-any', App\Models\Clean::class))
              <x-sidebars.nav-dropdown-desktop control="environments" title="Environments">
                  <x-slot name="content">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                          stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          @if (Auth::user()->can('view-any', Spatie\Permission\Models\Role::class) ||
              ...
              <x-sidebars.nav-dropdown-desktop control="access-managements" title="Access Managements">
                  <x-slot name="content">
                      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24"
                          stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          @role('super-admin')
              <x-sidebars.nav-dropdown-desktop control="data-settings" title="Data Settings">
                  <x-slot name="content">
                      <svg x-data="{ isOn: false }" @click="isOn = !isOn" :aria-checked="isOn"
                          :class="{ 'text-gray-500': isOn, 'text-gray-400 group-hover:text-gray-500': !isOn }"
                  ...
                  <x-sidebars.dropdown-link href="{{ route('parent-account-cashlesses.index') }}">
                      Parent Account Cashless
                  </x-sidebars.dropdown-link>
