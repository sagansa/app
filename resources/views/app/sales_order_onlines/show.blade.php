        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                ...
                <x-shows.dl>
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.sales_order_onlines.inputs.image')</x-shows.dt
                        >
                    ...
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.sales_order_onlines.inputs.store_id')</x-shows.dt
                        >
                        <x-shows.dd
                    ...
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.sales_order_onlines.inputs.online_shop_provider_id')</x-shows.dt
                        >
                        <x-shows.dd
                            >{{
                    ...
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.sales_order_onlines.inputs.delivery_service_id')</x-shows.dt
                        >
                        <x-shows.dd
                            >{{
                    ...
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.sales_order_onlines.inputs.customer_id')</x-shows.dt
                        >
                        <x-shows.dd
                    ...
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.sales_order_onlines.inputs.date')</x-shows.dt
                        >
                        <x-shows.dd
                            >{{ $salesOrderOnline->date ?? '-' }}</x-shows.dd
                        >
                    </x-shows.sub-dl>
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.sales_order_onlines.inputs.status')</x-shows.dt
                        >
                        <x-shows.dd
                            >{{ $salesOrderOnline->status ?? '-' }}</x-shows.dd
                        >
                    </x-shows.sub-dl>
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.sales_order_onlines.inputs.created_by_id')</x-shows.dt
                        >
                        <x-shows.dd
                    ...
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.sales_order_onlines.inputs.approved_by_id')</x-shows.dt
                        >
                        <x-shows.dd
                    ...
                    <x-shows.sub-dl>
                        <x-shows.dt
                            >@lang('crud.sales_order_onlines.inputs.notes')</x-shows.dt
                        >
                        <x-shows.dd
